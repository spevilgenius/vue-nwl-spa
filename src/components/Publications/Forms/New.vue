<template>
  <b-container fluid class="contentHeight m-0 p-0">
    <b-overlay :show="!formReady" variant="loading" class="contentHeight m-0 p-0">
...
export default class New extends Vue {
  ...
  public async saveForm() {
    ...
    try {
      ...
      this.$router.push({ path: '/pubs/approved/all/edit/' + id + '/' + this.nato + '/Yes/' + encodeURIComponent(name) })
    } catch (error) {
